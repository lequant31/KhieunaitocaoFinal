...
{
    public partial class ctlDanhMucDonThuToCao : UserControl
    {
        public ctlDanhMucDonThuToCao()
        {
            InitializeComponent();
        }
        ...
        private void btn_loaddataall_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PrinterPreviewDonToCaoPX05((DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
        ...
        private void ctlDanhMucDonThuToCao_Load(object sender, EventArgs e)
        {
        ...
        private void loaddata()
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PrinterPreviewDonToCao(dinhdanh.madonvi, (DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
                grc_danhmuckhieunai.DataSource = _list;
        ...
        private void btnExportExel_ItemClick(object sender, ItemClickEventArgs e)
        {
            ExportExcel("");
        }
