...
{
    public partial class ctlPhanTichThongKeToCao : UserControl
    {
        public ctlPhanTichThongKeToCao()
        {
            InitializeComponent();
        }
        khieunaitocaoContextDataContext khieunaitocaoContextDataContext;
        private void ctlPhanTichThongKeToCao_Load(object sender, EventArgs e)
        {
        ...
        private void loaddata()
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PhanTichThongKeToCao(dinhdanh.madonvi, (DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
        ...
        private void btn_LoadAll_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PhanTichThongKeToCaoPX05((DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
                grc_thongke.DataSource = _list;
            }
        }
    }
