...
{
    public partial class ctlDanhMucDonThuTongHop : UserControl
    {
        public ctlDanhMucDonThuTongHop()
        {
            InitializeComponent();
        }
        ...
        private void btn_loaddataall_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.TongHopPX05((DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
        ...
        private void loaddata()
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.TongHopDonVi(dinhdanh.madonvi, (DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
                grc_danhmuckhieunai.DataSource = _list;
