...
{
    public partial class ctlDanhMucDonKNPA : UserControl
    {
        public ctlDanhMucDonKNPA()
        {
            InitializeComponent();
        }
        ...
        private void btn_loaddataall_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PrinterPreviewDonKNPAPX05((DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
        ...
        private void loaddata()
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PrinterPreviewDonKNPA(dinhdanh.madonvi, (DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
                grc_danhmuckhieunai.DataSource = _list;
