...
{
    public partial class ctlPhanTichThongKeKhieuNai : UserControl
    {
        public ctlPhanTichThongKeKhieuNai()
        {
            InitializeComponent();
        }
        ...
        private void loaddata()
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PhanTichThongKeKhieuNai(dinhdanh.madonvi, (DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
        ...
        private void btn_LoadAll_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            using (khieunaitocaoContextDataContext = new khieunaitocaoContextDataContext())
            {
                ...
                var _list = khieunaitocaoContextDataContext.PhanTichThongKeKhieuNaiPX05((DateTime)date_tungay.EditValue, (DateTime)date_denngay.EditValue).ToList();
                grc_thongke.DataSource = _list;
            }
        }
    }
